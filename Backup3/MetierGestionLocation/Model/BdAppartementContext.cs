...
namespace MetierGestionLocation.Model
{
    ...
    public class BdAppartementContext:DbContext
    {
        ...
        { 
            // Désactiver la création de proxies dynamiques pour éviter les erreurs de sérialisation WCF
            this.Configuration.ProxyCreationEnabled = false;
            // Désactiver le lazy loading pour éviter les problèmes de sérialisation
